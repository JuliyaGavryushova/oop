...
public class Main {
        public static void main(String[] args) {
                ...
                pharmacy2.addComponent(new Component("Ascorbic", "0,5", 10))
                                .addComponent(new Component("Water", "1,5", 4));

                Pharmacy pharmacy3 = new Pharmacy();
                pharmacy3.addComponent(new Component("Penicillin", "0,5", 10))
                                .addComponent(new Component("Water", "1,5", 4));
                ...
                pharmacy5.addComponent(new Component("Penicillin", "0,5", 18))
                                .addComponent(new Component("Water", "1,2", 6))
                                .addComponent(new Component("Water", "1,2", 5));
